...
export default function MyDropdown(props) {
	...
	return(
		<View style={[styles.inputContainer, validationStyles]}>
		 	<ModalDropdown name="type" textStyle = {styles.dropdownDefaultText} dropdownTextStyle={styles.dropdownText} options={['Furniture', 'Clothes', 'Books', 'Appliances', 'Shoes', 'Accessories', 'Misc.']} defaultValue="Select" value = {input.value}
